...
return [
    ...
    | usando a convenção "attribute.rule" para nomear as linhas. Isso nos permite
    | especificar rapidamente uma linha de idioma personalizada específica para uma regra de atributo dada.
    |
    */
    ...
    | por algo mais fácil de entender, como "Endereço de E-Mail" em vez de "email". Isso simplesmente nos ajuda a tornar
    | nossa mensagem mais expressiva.
    |
    */

    'attributes' => [
        // Adicione atributos personalizados aqui, se necessário.
    ],
